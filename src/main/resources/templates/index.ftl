...
<head>
    ...
    <script src="${request.contextPath}/static/common/js/jquery-1.11.1.min.js"></script>
    <link href="${request.contextPath}/static/common/css/style.css" rel="stylesheet" type="text/css"/>
    <style type="text/css">
        .pageDetail {
            display: none;
        }
